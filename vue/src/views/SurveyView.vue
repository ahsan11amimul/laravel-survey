  ...
  <PageComponent>
      ...
      <form @submit.prevent="saveSurvey">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <!-- survey fields -->
          <div class="px-4 py-5 bg-white spce-y-6 sm:p-6">
          <!-- image -->
          <div>
            ...
            <button  type="button" class="relative overflow-hidden ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md
            shadow-sm
            text-sm
            leading-4
            font-medium
          ...
          <!-- title -->
            <div>
               ...
               <input type="text" name="title" id="title" v-model="model.title" autocomplete="survey.title" class="
               mt-1
            ...
            <div>
               ...
               <div class="mt-1">
                <textarea name="description" rows="3" id="description" v-model="model.description" autocomplete="survey.descrition" 
               placeholder="describe about your survey " 
               class="
               mt-1
               focus:ring-indigo-500 focus:border-indigo-500
               block
